...
| **Live demo** | Marketed DUPR; "26,000+ courts with reviews"; pinch-zoom disabled; five `<h1>`s; no canonical; Austin and San Francisco fixtures mixed; June/July dates shown as upcoming | All corrected; one city (Austin); dates that cannot rot ("Next month", "Season in progress"); Google Fonts removed; 335 KB PNG → 19 KB | Guided tour is Phase H; this pass made the demo true |
